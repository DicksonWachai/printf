...
/**
 * print_x - take unsigned int, prints it in lowercase hex notation
...
/**
 * print_X - takes unsigned int, prints it in uppercase hex notation
 * @X: unsigned int to print
 *
 * Return: number of digits printed
 */
